...
# Spatiotemporal behaviour of a male wild boar, sus scrofa, in the pre-Alps of the canton Fribourg

#### Projet for the course "Patterns and trends in environmental data"
...
####Preprocessing This data set required some supplements derived from
the base file data to allow for further analysis to answer the questions
outlined in the introduction to this project.A first visual analysis of
the file in excel was done to observe the data.
...
0 - no hunting 1 - only wild boar hunting 2 - hunting of wild boar + 1
other species 3 - wild boar hunting + 2 other species
