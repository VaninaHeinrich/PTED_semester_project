...
```{r, fig.cap="Fig 9: Speed depending on daytime", fig.align='center'}
...
```{r, fig.cap="Fig 10: Speed depending on daytime for each month", fig.align='center'}
...
Boxplot results show greater forest use during the hunting season (Figure 11). Grassland use is similar between periods. 

```{r, fig.cap="Fig 11: Landcover use depending on hunting", fig.align='center'}
...
```{r}
knitr::kable(df, caption = "This table shows...")
```
